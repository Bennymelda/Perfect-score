const CTA = () => {
    ...
    <div className="flex justify-center shadow bg-[#f3ebf9] dark:bg-[#272f43]  p-5 md:p-10 rounded-4xl items-center gap-5 md:gap-10 flex-col">
        ...
        <div>
            <div className="flex cursor-pointer items-center gap-4 shadow-b-lg flex-gap-2 text-white w-fit rounded-4xl bg-[#5300b7] font-semibold px-8 py-4 md:py-4 dark:text-[#381e72] dark:bg-[#d3bbff]"><button>Sign Up Now</button></div>
